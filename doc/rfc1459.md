...
To provide accurate and valid replies to the ADMIN command (see [4.3.7 Admin command](#437-admin-command)), the server should find the relevant details in the configuration.
